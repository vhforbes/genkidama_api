        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const updatesUidsOnDb = () => __awaiter(this, void 0, void 0, function* () {
                uidList.forEach((uid) => __awaiter(this, void 0, void 0, function* () {
                    const alreadyAdded = yield bitgetUIDRepository.findOne({
                        where: { BitgetUID: uid },
                    });
                    if (!alreadyAdded) {
                        ...
                        yield bitgetUIDRepository.save(newAssociateEntry);
                    }
                }));
            });
...
exports.default = UpdateBitgetAssociateService;
//# sourceMappingURL=UpdatedBitgetAssociatesService.js.map