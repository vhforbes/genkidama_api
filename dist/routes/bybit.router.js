...
const bybitRouter = (0, express_1.Router)();
bybitRouter.use(ensureAuthenticated_1.ensureAutenticated);
bybitRouter.post('/associated', ensureAdmin_1.ensureAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { uidList } = req.body;
    yield UpdatedBitgetAssociatesService_1.default.execute({ uidList });
    return res.json({ result: 'List updated' });
}));
bybitRouter.get('/associated', ensureAdmin_1.ensureAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.default = bybitRouter;
//# sourceMappingURL=bybit.router.js.map